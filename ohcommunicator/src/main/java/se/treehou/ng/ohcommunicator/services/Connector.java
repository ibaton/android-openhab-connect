...
public class Connector {
    ...
    public static class ServerHandler {
        ...
        public static class PollSocket {
            final Socket pollSocket;
            final AsyncHttpClient asyncHttpClient;

            public PollSocket(Socket pollSocket, AsyncHttpClient asyncHttpClient) {
                this.pollSocket = pollSocket;
        ...
        @WorkerThread
        public PollSocket requestPageUpdates(final OHServer server, final OHLinkedPage page, final OHCallback<OHLinkedPage> callback) {
            final Socket pollSocket;
            final AsyncHttpClient asyncHttpClient;
            ...
            return new PollSocket(pollSocket, asyncHttpClient);
        }
